...
const c = {
  ...
  inp: {width:"100%",background:"#0f1a0f",border:"1px solid #3d6b3d",borderRadius:8,color:"#e8f0e8",padding:"10px 12px",fontSize:16,boxSizing:"border-box",outline:"none",minHeight:44},
  sel: {width:"100%",background:"#0f1a0f",border:"1px solid #3d6b3d",borderRadius:8,color:"#e8f0e8",padding:"10px 12px",fontSize:16,boxSizing:"border-box",minHeight:44},
